...
export function TeamMemberCard({
  ...
  return (
    ...
    >
      ...
      {/* Rendered as a sibling (not nested inside the Link's <a>) to avoid invalid nested anchors */}
      {member.linkedin && (
        <a
          ...
          className="absolute right-5 top-5 flex h-9 w-9 translate-y-2 items-center justify-center rounded-full bg-white text-zinc-900 opacity-0 shadow-sm transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100"
        >
